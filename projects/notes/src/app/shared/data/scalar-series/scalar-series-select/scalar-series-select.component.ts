...
export class ScalarSeriesSelectComponent extends SeriesSelect {
  ...
  protected readonly seriesArray = computed(() => this.scalarSeriesService.series());
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (selected) {
        this.selectionChange.emit(selected as ScalarSeries);
      }
    });
  }
