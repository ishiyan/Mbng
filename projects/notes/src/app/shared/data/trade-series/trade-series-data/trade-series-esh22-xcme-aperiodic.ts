...
export const tradeSeriesEsh22XcmeAperiodic: Series = {
  mnemonic: 'esh22:xcme',
  description: 'E-mini S&P500 ESH22 future series on CME.',
  ...
  data: [
    ...
    { time: new Date(2021, 0, 4), price: 3.2, volume: 1 },

    { time: new Date(2022, 6, 7), price: 5.5, volume: 1 }
  ],
};
