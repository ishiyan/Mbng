...
export class QuoteSeriesSelectComponent extends SeriesSelect {
  ...
  protected readonly seriesArray = computed(() => this.quoteSeriesService.series());
  ...
  constructor() {
    ...
    effect(() => {
      ...
      if (selected) {
        this.selectionChange.emit(selected as QuoteSeries);
      }
    });
  }
