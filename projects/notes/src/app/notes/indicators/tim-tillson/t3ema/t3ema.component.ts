...
@Component({
    ...
    imports: [MatSlideToggle, FormsModule, MatIcon, BarSeriesSelectComponent, OhlcvChartModule, NgIf, MatExpansionPanel, MatExpansionPanelHeader, MatExpansionPanelTitle, SwatchesSelectComponent, T3emaListComponent, KatexModule, FrequencyResponseChartModule, MatFormField, MatLabel, MatInput]
})
