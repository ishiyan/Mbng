...
@Component({
  selector: 'app-mb-data-generators-01-chirp-features',
  templateUrl: './generators-01-chirp-features.component.html',
  styleUrls: ['./generators-01-chirp-features.component.scss'],
