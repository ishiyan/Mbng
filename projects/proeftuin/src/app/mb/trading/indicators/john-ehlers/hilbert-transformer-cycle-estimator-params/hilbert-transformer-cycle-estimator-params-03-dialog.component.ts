...
@Component({
  selector: 'app-mb-hilbert-transformer-cycle-estimator-params-03-dialog',
  templateUrl: './hilbert-transformer-cycle-estimator-params-03-dialog.component.html',
  styleUrls: ['./hilbert-transformer-cycle-estimator-params-03-dialog.component.scss'],
...
export class HilbertTransformerCycleEstimatorParams03DialogComponent {
