...
@Component({
  selector: 'app-mb-fractal-adaptive-moving-average-params-02-selector',
  templateUrl: './fractal-adaptive-moving-average-params-02-selector.component.html',
  styleUrls: ['./fractal-adaptive-moving-average-params-02-selector.component.scss'],
...
export class FractalAdaptiveMovingAverageParams02SelectorComponent {
