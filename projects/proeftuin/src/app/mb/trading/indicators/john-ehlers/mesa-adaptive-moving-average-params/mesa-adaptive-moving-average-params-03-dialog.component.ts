...
@Component({
  selector: 'app-mb-mesa-adaptive-moving-average-params-03-dialog',
  templateUrl: './mesa-adaptive-moving-average-params-03-dialog.component.html',
  styleUrls: ['./mesa-adaptive-moving-average-params-03-dialog.component.scss'],
...
export class MesaAdaptiveMovingAverageParams03DialogComponent {
