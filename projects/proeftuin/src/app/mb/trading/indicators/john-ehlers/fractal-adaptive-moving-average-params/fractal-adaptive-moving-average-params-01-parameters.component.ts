...
@Component({
  selector: 'app-mb-fractal-adaptive-moving-average-params-01-parameters',
  templateUrl: './fractal-adaptive-moving-average-params-01-parameters.component.html',
  styleUrls: ['./fractal-adaptive-moving-average-params-01-parameters.component.scss'],
...
export class FractalAdaptiveMovingAverageParams01ParametersComponent {
