...
@Component({
  selector: 'app-mb-mesa-adaptive-moving-average-params-01-parameters',
  templateUrl: './mesa-adaptive-moving-average-params-01-parameters.component.html',
  styleUrls: ['./mesa-adaptive-moving-average-params-01-parameters.component.scss'],
...
export class MesaAdaptiveMovingAverageParams01ParametersComponent {
