...
@Component({
  selector: 'app-mb-mesa-adaptive-moving-average-params-02-selector',
  templateUrl: './mesa-adaptive-moving-average-params-02-selector.component.html',
  styleUrls: ['./mesa-adaptive-moving-average-params-02-selector.component.scss'],
...
export class MesaAdaptiveMovingAverageParams02SelectorComponent {
