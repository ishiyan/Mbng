...
@Component({
  selector: 'app-mb-standard-deviation-01-parameters',
  templateUrl: './standard-deviation-01-parameters.component.html',
  styleUrls: ['./standard-deviation-01-parameters.component.scss'],
...
export class StandardDeviation01ParametersComponent {
