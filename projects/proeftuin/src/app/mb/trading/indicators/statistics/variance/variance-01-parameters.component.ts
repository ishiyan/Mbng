...
@Component({
  selector: 'app-mb-variance-01-parameters',
  templateUrl: './variance-01-parameters.component.html',
  styleUrls: ['./variance-01-parameters.component.scss'],
...
export class Variance01ParametersComponent {
