...
@Component({
  selector: 'app-mb-double-exponential-moving-average-01-parameters',
  templateUrl: './double-exponential-moving-average-01-parameters.component.html',
  styleUrls: ['./double-exponential-moving-average-01-parameters.component.scss'],
...
export class DoubleExponentialMovingAverage01ParametersComponent {
