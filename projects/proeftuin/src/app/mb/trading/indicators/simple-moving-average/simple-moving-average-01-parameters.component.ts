...
@Component({
  selector: 'app-mb-simple-moving-average-01-parameters',
  templateUrl: './simple-moving-average-01-parameters.component.html',
  styleUrls: ['./simple-moving-average-01-parameters.component.scss'],
...
export class SimpleMovingAverage01ParametersComponent {
