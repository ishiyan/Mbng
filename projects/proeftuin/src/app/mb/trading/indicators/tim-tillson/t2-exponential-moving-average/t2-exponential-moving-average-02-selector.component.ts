...
@Component({
  selector: 'app-mb-t2-exponential-moving-average-02-selector',
  templateUrl: './t2-exponential-moving-average-02-selector.component.html',
  styleUrls: ['./t2-exponential-moving-average-02-selector.component.scss'],
...
export class T2ExponentialMovingAverage02SelectorComponent {
