...
@Component({
  selector: 'app-mb-t2-exponential-moving-average-01-parameters',
  templateUrl: './t2-exponential-moving-average-01-parameters.component.html',
  styleUrls: ['./t2-exponential-moving-average-01-parameters.component.scss'],
...
export class T2ExponentialMovingAverage01ParametersComponent {
