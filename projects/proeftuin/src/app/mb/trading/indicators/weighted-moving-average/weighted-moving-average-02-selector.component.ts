...
@Component({
  selector: 'app-mb-weighted-moving-average-02-selector',
  templateUrl: './weighted-moving-average-02-selector.component.html',
  styleUrls: ['./weighted-moving-average-02-selector.component.scss'],
...
export class WeightedMovingAverage02SelectorComponent {
