...
@Component({
  selector: 'app-mb-jurik-moving-average-01-parameters',
  templateUrl: './jurik-moving-average-01-parameters.component.html',
  styleUrls: ['./jurik-moving-average-01-parameters.component.scss'],
...
export class JurikMovingAverage01ParametersComponent {
