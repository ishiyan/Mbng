...
@Component({
  selector: 'app-sample-kaufman-adaptive-moving-average-1',
  templateUrl: './sample-kaufman-adaptive-moving-average-1.component.html',
  styleUrls: ['./sample-kaufman-adaptive-moving-average-1.component.scss'],
...
export class SampleKaufmanAdaptiveMovingAverage1Component {
