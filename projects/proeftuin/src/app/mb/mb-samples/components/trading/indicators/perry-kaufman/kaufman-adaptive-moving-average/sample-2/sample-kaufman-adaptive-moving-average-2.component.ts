...
@Component({
  selector: 'app-sample-kaufman-adaptive-moving-average-2',
  templateUrl: './sample-kaufman-adaptive-moving-average-2.component.html',
  styleUrls: ['./sample-kaufman-adaptive-moving-average-2.component.scss'],
...
export class SampleKaufmanAdaptiveMovingAverage2Component {
