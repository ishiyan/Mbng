...
@Component({
  selector: 'app-sample-fractal-adaptive-moving-average-params-3',
  templateUrl: './sample-fractal-adaptive-moving-average-params-3.component.html',
  styleUrls: ['./sample-fractal-adaptive-moving-average-params-3.component.scss'],
...
export class SampleFractalAdaptiveMovingAverageParams3Component {
