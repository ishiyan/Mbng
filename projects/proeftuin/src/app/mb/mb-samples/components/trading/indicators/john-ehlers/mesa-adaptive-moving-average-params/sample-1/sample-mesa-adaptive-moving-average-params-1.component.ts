...
@Component({
  selector: 'app-sample-mesa-adaptive-moving-average-params-1',
  templateUrl: './sample-mesa-adaptive-moving-average-params-1.component.html',
  styleUrls: ['./sample-mesa-adaptive-moving-average-params-1.component.scss'],
...
export class SampleMesaAdaptiveMovingAverageParams1Component {
