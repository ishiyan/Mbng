...
@Component({
  selector: 'app-sample-fractal-adaptive-moving-average-params-2',
  templateUrl: './sample-fractal-adaptive-moving-average-params-2.component.html',
  styleUrls: ['./sample-fractal-adaptive-moving-average-params-2.component.scss'],
...
export class SampleFractalAdaptiveMovingAverageParams2Component {
