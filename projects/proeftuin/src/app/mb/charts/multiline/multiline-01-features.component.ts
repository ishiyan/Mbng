...
@Component({
  selector: 'app-mb-multiline-01-features',
  templateUrl: './multiline-01-features.component.html',
  styleUrls: ['./multiline-01-features.component.scss'],
...
export class Multiline01FeaturesComponent {
