...
@Component({
  selector: 'app-mb-treemap-04-omxn40',
  templateUrl: './treemap-04-omxn40.component.html',
  styleUrls: ['./treemap-04-omxn40.component.scss'],
...
export class Treemap04Omxn40Component {
  flat = false;
