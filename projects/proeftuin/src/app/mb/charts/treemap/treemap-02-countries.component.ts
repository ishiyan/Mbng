...
@Component({
  selector: 'app-mb-treemap-02-countries',
  templateUrl: './treemap-02-countries.component.html',
  styleUrls: ['./treemap-02-countries.component.scss'],
...
export class Treemap02CountriesComponent {
