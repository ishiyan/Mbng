...
@Component({
  selector: 'app-mb-sunburst-04-omxn40',
  templateUrl: './sunburst-04-omxn40.component.html',
  styleUrls: ['./sunburst-04-omxn40.component.scss'],
...
export class Sunburst04Omxn40Component {
