...
@Component({
  selector: 'app-mb-sunburst-02-countries',
  templateUrl: './sunburst-02-countries.component.html',
  styleUrls: ['./sunburst-02-countries.component.scss'],
...
export class Sunburst02CountriesComponent {
