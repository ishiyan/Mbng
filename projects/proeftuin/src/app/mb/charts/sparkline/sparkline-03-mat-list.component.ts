...
@Component({
  selector: 'app-sparkline-03-mat-list',
  templateUrl: './sparkline-03-mat-list.component.html',
  styleUrls: ['./sparkline-03-mat-list.component.scss'],
...
export class Sparkline03MatListComponent {
