...
@Component({
  selector: 'app-sparkline-02-mat-select',
  templateUrl: './sparkline-02-mat-select.component.html',
  styleUrls: ['./sparkline-02-mat-select.component.scss'],
...
export class Sparkline02MatSelectComponent {
