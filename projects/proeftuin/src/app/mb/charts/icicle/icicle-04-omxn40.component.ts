...
@Component({
  selector: 'app-mb-icicle-04-omxn40',
  templateUrl: './icicle-04-omxn40.component.html',
  styleUrls: ['./icicle-04-omxn40.component.scss'],
...
export class Icicle04Omxn40Component {
