...
@Component({
  selector: 'app-mb-icicle-02-countries',
  templateUrl: './icicle-02-countries.component.html',
  styleUrls: ['./icicle-02-countries.component.scss'],
...
export class Icicle02CountriesComponent {
