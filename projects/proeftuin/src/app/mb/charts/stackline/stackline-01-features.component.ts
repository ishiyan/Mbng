...
@Component({
  selector: 'app-mb-stackline-01-features',
  templateUrl: './stackline-01-features.component.html',
  styleUrls: ['./stackline-01-features.component.scss'],
...
export class Stackline01FeaturesComponent {
