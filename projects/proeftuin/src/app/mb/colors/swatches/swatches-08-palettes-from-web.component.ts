...
@Component({
  selector: 'app-mb-swatches-08-palettes-from-web',
  templateUrl: './swatches-08-palettes-from-web.component.html',
  styleUrls: ['./swatches-08-palettes-from-web.component.scss'],
...
export class Swatches08PalettesFromWebComponent {
