...
@Component({
  selector: 'app-mb-swatches-06-parametric-procedural-palettes',
  templateUrl: './swatches-06-parametric-procedural-palettes.component.html',
  styleUrls: ['./swatches-06-parametric-procedural-palettes.component.scss'],
...
export class Swatches06ParametricProceduralPalettesComponent {
