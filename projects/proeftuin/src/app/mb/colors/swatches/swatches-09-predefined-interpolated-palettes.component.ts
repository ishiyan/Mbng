...
@Component({
  selector: 'app-mb-swatches-09-predefined-interpolated-palettes',
  templateUrl: './swatches-09-predefined-interpolated-palettes.component.html',
  styleUrls: ['./swatches-09-predefined-interpolated-palettes.component.scss'],
...
export class Swatches09PredefinedInterpolatedPalettesComponent {
