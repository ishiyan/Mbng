...
@Component({
  selector: 'app-mb-swatches-02-material-palettes',
  templateUrl: './swatches-02-material-palettes.component.html',
  styleUrls: ['./swatches-02-material-palettes.component.scss'],
...
export class Swatches02MaterialPalettesComponent {
