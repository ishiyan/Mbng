...
@Component({
  selector: 'app-mb-swatches-05-random-procedural-palettes',
  templateUrl: './swatches-05-random-procedural-palettes.component.html',
  styleUrls: ['./swatches-05-random-procedural-palettes.component.scss'],
...
export class Swatches05RandomProceduralPalettesComponent {
