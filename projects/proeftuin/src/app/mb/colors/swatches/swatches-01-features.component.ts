...
@Component({
  selector: 'app-mb-swatches-01-features',
  templateUrl: './swatches-01-features.component.html',
  styleUrls: ['./swatches-01-features.component.scss'],
...
export class Swatches01FeaturesComponent {
