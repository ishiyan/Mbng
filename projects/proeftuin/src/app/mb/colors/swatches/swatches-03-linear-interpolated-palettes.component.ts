...
@Component({
  selector: 'app-mb-swatches-03-linear-interpolated-palettes',
  templateUrl: './swatches-03-linear-interpolated-palettes.component.html',
  styleUrls: ['./swatches-03-linear-interpolated-palettes.component.scss'],
...
export class Swatches03LinearInterpolatedPalettesComponent {
