...
@Component({
  selector: 'app-mb-swatches-10-predefined-line-palettes',
  templateUrl: './swatches-10-predefined-line-palettes.component.html',
  styleUrls: ['./swatches-10-predefined-line-palettes.component.scss'],
...
export class Swatches10PredefinedLinePalettesComponent {
