...
@Component({
  selector: 'app-mb-color-picker-01-features',
  templateUrl: './color-picker-01-features.component.html',
  styleUrls: ['./color-picker-01-features.component.scss'],
...
export class ColorPicker01FeaturesComponent {
