...
@Component({
  selector: 'app-sample-hilbert-transformer-cycle-estimator-params-1',
  templateUrl: './sample-hilbert-transformer-cycle-estimator-params-1.component.html',
  styleUrls: ['./sample-hilbert-transformer-cycle-estimator-params-1.component.scss'],
...
export class SampleHilbertTransformerCycleEstimatorParams1Component {
