...
@Component({
  ...
  imports: [
    ...
    D3tcCloseComponent,
    D3tcVolumeComponent,
    D3tcAxisAnnotationsComponent,
    D3tcCrosshairComponent,
    D3tcBrushComponent,
    D3tcTrendlinesComponent,
    D3tcSupportResistanceComponent,
    D3tcZoomingComponent,
    D3tcMultipleSmallPlotsComponent,
    D3tcTradeArrowsComponent,
    D3tcArrowComponent,
    D3tcFinanceTimeComponent
  ]
})
export class TechanComponent { }
