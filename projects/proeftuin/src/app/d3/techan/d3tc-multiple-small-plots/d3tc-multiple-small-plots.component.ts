import { Component, ElementRef, input, viewChild, ChangeDetectionStrategy, PLATFORM_ID, inject, afterNextRender, OnDestroy } from '@angular/core';
...
@Component({
  selector: 'app-d3-techan-d3tc-multiple-small-plots',
  templateUrl: './d3tc-multiple-small-plots.component.html',
  styleUrls: ['./d3tc-multiple-small-plots.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class D3tcMultipleSmallPlotsComponent implements OnDestroy {
