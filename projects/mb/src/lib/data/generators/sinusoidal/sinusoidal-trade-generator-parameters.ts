...
import {
  sampleCountName, timeParametersName, waveformParametersName, sinusoidalParametersName, tradeParametersName,
  objectName
} from '../constants';
...
export class SinusoidalTradeGeneratorParameters {
  ...
  constructor(data?: SinusoidalTradeGeneratorParameters) {
    if (data) {
