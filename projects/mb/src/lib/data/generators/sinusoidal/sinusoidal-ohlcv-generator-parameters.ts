...
import {
  sampleCountName, timeParametersName, waveformParametersName, sinusoidalParametersName, ohlcvParametersName,
  objectName
} from '../constants';
...
export class SinusoidalOhlcvGeneratorParameters {
  ...
  constructor(data?: SinusoidalOhlcvGeneratorParameters) {
    if (data) {
