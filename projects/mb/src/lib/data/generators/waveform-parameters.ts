...
import {
  objectName, waveformSamplesName, offsetSamplesName, repetitionsCountName, noiseAmplitudeFractionName,
  noiseUniformRandomGeneratorKindName, noiseUniformRandomGeneratorSeedName
} from './constants';
