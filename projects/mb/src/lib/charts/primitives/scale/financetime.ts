 ...
 */
export const financetime = function (scale_widen: any) { // Injected dependencies
  ...
  var dayFormat = d3.timeFormat('%b %e'),
    ...
    genericFormat = [d3.timeSecond, 1, d3_v3_multi_shim([
      [d3.timeFormat(':%S'), function (d: any) { return d.getSeconds(); }],
      [d3.timeFormat('%I:%M'), function (d: any) { return d.getMinutes(); }],
  ...
  var dayFormatUtc = d3.utcFormat('%b %e'),
    ...
    genericFormatUtc = [d3.timeSecond, 1, d3_v3_multi_shim([
      [d3.utcFormat(':%S'), function (d: any) { return d.getUTCSeconds(); }],
      [d3.utcFormat('%I:%M'), function (d: any) { return d.getUTCMinutes(); }],
