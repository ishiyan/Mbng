export const candlestick = function (accessor_ohlc: any, plot: any, plotMixin: any) {
  return function () { // Closure constructor
    var p = {} as any, // Container for private, direct access mixed in variables
      bodyPathGenerator: any,
      wickGenerator: any,
      wickWidthGenerator: any;
    ...
    function wickPath() {
      ...
      return function (d: any) {
        var open = y(accessor.o(d)),
          ...
          // Top
          path = 'M ' + xPoint + ' ' + y(accessor.h(d)) + ' L ' + xPoint + ' ' + Math.min(open, close);
