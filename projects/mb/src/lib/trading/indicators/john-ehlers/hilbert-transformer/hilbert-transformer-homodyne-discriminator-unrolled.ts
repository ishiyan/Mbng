...
export class HilbertTransformerHomodyneDiscriminatorUnrolled implements HilbertTransformerCycleEstimator {
   ...
   */
  public get smoothedValue(): number { return this.smoothed; }
  ...
  public update(sample: number): void {
    ...
    let detrender, ji, jq;
    let temp = a * this.smoothedValue; this.adjustedPeriod = c0075 * this.period + c054;
    if (0 === this.count % 2) { // Even value count.
      ...
      if (0 === this.index) {
        ...
        this.detrenderPreviousEven = b * this.detrenderPreviousInputEven; this.detrenderPreviousInputEven = val;
        detrender += this.detrenderPreviousEven; detrender *= this.adjustedPeriod;
        // Quadrature component.
        temp = a * detrender; this.quadrature = -this.q1Even0; this.q1Even0 = temp; this.quadrature += temp; this.quadrature -= this.q1PreviousEven;
        this.q1PreviousEven = b * this.q1PreviousInputEven; this.q1PreviousInputEven = detrender;
        this.quadrature += this.q1PreviousEven; this.quadrature *= this.adjustedPeriod;
        ...
        temp = a * this.quadrature; jq = -this.jqEven0; this.jqEven0 = temp;
        ...
        detrender += this.detrenderPreviousEven; detrender *= this.adjustedPeriod;
        // Quadrature component.
        temp = a * detrender; this.quadrature = -this.q1Even1; this.q1Even1 = temp; this.quadrature += temp; this.quadrature -= this.q1PreviousEven;
        this.q1PreviousEven = b * this.q1PreviousInputEven; this.q1PreviousInputEven = detrender;
        this.quadrature += this.q1PreviousEven; this.quadrature *= this.adjustedPeriod;
        // Advance the phase of the InPhase component by 90°.
        ...
        ji += this.jiPreviousEven; ji *= this.adjustedPeriod;
        // Advance the phase of the Quadrature component by 90°.
        temp = a * this.quadrature; jq = -this.jqEven1; this.jqEven1 = temp;
      } else { //if (2 == index)
        this.index = 0;
        ...
        detrender += this.detrenderPreviousEven; detrender *= this.adjustedPeriod;
        // Quadrature component.
        temp = a * detrender; this.quadrature = -this.q1Even2; this.q1Even2 = temp; this.quadrature += temp; this.quadrature -= this.q1PreviousEven;
        this.q1PreviousEven = b * this.q1PreviousInputEven; this.q1PreviousInputEven = detrender;
        this.quadrature += this.q1PreviousEven; this.quadrature *= this.adjustedPeriod;
        // Advance the phase of the InPhase component by 90°.
        ...
        ji += this.jiPreviousEven; ji *= this.adjustedPeriod;
        // Advance the phase of the Quadrature component by 90°.
        temp = a * this.quadrature; jq = -this.jqEven2; this.jqEven2 = temp;
      }
      // Advance the phase of the Quadrature component by 90° (continued).
      jq += temp; jq -= this.jqPreviousEven;
      this.jqPreviousEven = b * this.jqPreviousInputEven; this.jqPreviousInputEven = this.quadrature;
      jq += this.jqPreviousEven; jq *= this.adjustedPeriod;
      // InPhase component.
      this.inPhase = this.i1Previous2Even;
      ...
      if (0 === this.index) {
        ...
        this.detrenderPreviousOdd = b * this.detrenderPreviousInputOdd; this.detrenderPreviousInputOdd = val;
        detrender += this.detrenderPreviousOdd; detrender *= this.adjustedPeriod;
        // Quadrature component.
        temp = a * detrender; this.quadrature = -this.q1Odd0; this.q1Odd0 = temp; this.quadrature += temp; this.quadrature -= this.q1PreviousOdd;
        this.q1PreviousOdd = b * this.q1PreviousInputOdd; this.q1PreviousInputOdd = detrender;
        this.quadrature += this.q1PreviousOdd; this.quadrature *= this.adjustedPeriod;
        // Advance the phase of the InPhase component by 90°.
        ...
        // Advance the phase of the Quadrature component by 90°.
        temp = a * this.quadrature; jq = -this.jqOdd0; this.jqOdd0 = temp;
      } else if (1 === this.index) {
        this.index = 2;
        // Quadrature component.
        ...
        this.detrenderPreviousOdd = b * this.detrenderPreviousInputOdd; this.detrenderPreviousInputOdd = val;
        detrender += this.detrenderPreviousOdd; detrender *= this.adjustedPeriod;
        temp = a * detrender; this.quadrature = -this.q1Odd1; this.q1Odd1 = temp; this.quadrature += temp; this.quadrature -= this.q1PreviousOdd;
        this.q1PreviousOdd = b * this.q1PreviousInputOdd; this.q1PreviousInputOdd = detrender;
        this.quadrature += this.q1PreviousOdd; this.quadrature *= this.adjustedPeriod;
        // Advance the phase of the InPhase component by 90°.
        ...
        ji += this.jiPreviousOdd; ji *= this.adjustedPeriod;
        // Advance the phase of the Quadrature component by 90°.
        temp = a * this.quadrature; jq = -this.jqOdd1; this.jqOdd1 = temp;
      } else { //if (2 === index)
        this.index = 0;
        ...
        detrender += this.detrenderPreviousOdd; detrender *= this.adjustedPeriod;
        // Quadrature component.
        temp = a * detrender; this.quadrature = -this.q1Odd2; this.q1Odd2 = temp; this.quadrature += temp; this.quadrature -= this.q1PreviousOdd;
        this.q1PreviousOdd = b * this.q1PreviousInputOdd; this.q1PreviousInputOdd = detrender;
        this.quadrature += this.q1PreviousOdd; this.quadrature *= this.adjustedPeriod;
        // Advance the phase of the InPhase component by 90°.
        ...
        ji += this.jiPreviousOdd; ji *= this.adjustedPeriod;
        // Advance the phase of the Quadrature component by 90°.
        temp = a * this.quadrature; jq = -this.jqOdd2; this.jqOdd2 = temp;
      }
      // Advance the phase of the Quadrature component by 90° (continued).
      jq += temp; jq -= this.jqPreviousOdd;
      this.jqPreviousOdd = b * this.jqPreviousInputOdd; this.jqPreviousInputOdd = this.quadrature;
      jq += this.jqPreviousOdd; jq *= this.adjustedPeriod;
      // InPhase component.
      this.inPhase = this.i1Previous2Odd;
    ...
    this.detrended = detrender;
    // Phasor addition for 3 bar averaging.
    let i2 = this.inPhase - jq;
    let q2 = this.quadrature + ji;
    ...
    this.period = this.alphaEmaPeriod * this.period + this.oneMinAlphaEmaPeriod * temp;
  }
}
