...
export class DoubleExponentialMovingAverageParamsComponent implements AfterContentInit {
  ...
  protected paramsLength: DoubleExponentialMovingAverageLengthParams = {
    length: 6, firstIsAverage: firstIsAverageDefault, barComponent: BarComponent.Close
  };

  protected paramsAlpha: DoubleExponentialMovingAverageSmoothingFactorParams = {
  ...
  @Input() set initial(value: DoubleExponentialMovingAverageLengthParams | DoubleExponentialMovingAverageSmoothingFactorParams) {
    if (guardLength(value)) {
      this.paramsLength = value as DoubleExponentialMovingAverageLengthParams;
      this.firstIsAverage = this.paramsLength.firstIsAverage;
      this.useAlpha = false;
    } else {
      this.paramsAlpha = value as DoubleExponentialMovingAverageSmoothingFactorParams;
      this.useAlpha = true;
